    ...
    <>
      ...
      <section className="bg-gray/70 py-2">
        <div className="max-w-5xl mx-auto px-2">
          ...
          <div className="relative overflow-hidden">
            <div
              className="flex transition-transform duration-700 ease-in-out min-h-[320px]"
              style={{ transform: `translateX(-${currentSlide * 100}%)` }}
            >
              {loading
                ? [...Array(3)].map((_, i) => (
                    <div
                      ...
                      style={{ minWidth: "100%" }}
                    >
                      <div className="bg-white rounded-md p-4 animate-pulse space-y-2 min-h-[280px]">
                        <div className="bg-gray-300 h-32 rounded aspect-[4/3]" />
